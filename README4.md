...
<details open>
<summary>🗺️ 快速導航欄 - 直接跳轉</summary>

| 📍 | 🎯 導航 | 📍 | 🎯 導航 | 📍 | 🎯 導航 |
|:---:|:---|:---:|:---|:---:|:---|
| 1️⃣ | [📊 平台統計](#-平台統計面板) | 4️⃣ | [⚡ 場景導航](#-按場景快速導航) | 7️⃣ | [🎴 卡片視圖](#-資源卡片視圖) |
| 2️⃣ | [🚀 快速訪問](#-快速訪問中心) | 5️⃣ | [🔍 篩選搜索](#-快速搜索與篩選) | 8️⃣ | [📚 工作流](#-常用工作流) |
| 3️⃣ | [🎯 分類導航](#-快速導航) | 6️⃣ | [📂 詳細資源](#-詳細資源列表) | 9️⃣ | [📖 使用指南](#-開始使用) |
...
<details open>
<summary>📈 平台概況統計 · 自動更新中</summary>

<table style="border-collapse: collapse; width: 100%; margin: 15px 0;">
<thead style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
<tr style="padding: 12px;">
<th style="padding: 12px; text-align: center;">📊 統計項目</th>
<th style="padding: 12px; text-align: center;">📈 數值</th>
<th style="padding: 12px; text-align: center;">📅 更新時間</th>
<th style="padding: 12px; text-align: center;">📝 備註</th>
</tr>
</thead>
<tbody>
<tr style="background: rgba(102, 126, 234, 0.05); border-bottom: 2px solid var(--border-color);">
<td style="padding: 12px; text-align: center;">📄 檔案總數</td>
<td style="padding: 12px; text-align: center; font-weight: bold; color: var(--accent);">42 個</td>
<td style="padding: 12px; text-align: center;">2026-07-03</td>
...
<td style="padding: 12px; text-align: center; font-weight: bold; color: #28a745;">15 個</td>
<td style="padding: 12px; text-align: center;">2026-07-03</td>
<td style="padding: 12px;">工具與服務 📦 模組化</td>
</tr>
<tr style="background: rgba(255, 193, 7, 0.05);">
<td style="padding: 12px; text-align: center;">📚 文章數</td>
<td style="padding: 12px; text-align: center; font-weight: bold; color: #ffc107;">26 篇</td>
<td style="padding: 12px; text-align: center;">2026-07-03</td>
...
<td style="padding: 12px; text-align: center; font-weight: bold; color: #667eea;">8 個</td>
<td style="padding: 12px; text-align: center;">2026-07-03</td>
...
<td style="padding: 12px; text-align: center; font-weight: bold; color: #4caf50;">🟢 正常運作</td>
...
<details open>
<summary>📂 點擊展開：全站資源快速索引樹 · 含權限指示</summary>
...
<details open>
<summary>📂 按功能分類導航</summary>

### 📱 **響應式卡片佈局**（點擊卡片進入）

<table style="border-collapse: collapse; width: 100%;">
<tr>
<td style="padding: 15px; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px; margin: 5px;">
...
<tr>
<td style="padding: 15px; text-align: center; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white; border-radius: 8px; margin: 5px;">
...
<details open>
<summary>🔍 按條件篩選資源</summary>

### 📌 **按檔案格式篩選**
| 格式 | 🔗 快速鏈接 | 📊 數量 | 📝 說明 |
|:---:|---|:---:|---|
| 🟦 HTML | [查看所有](#-詳細資源列表) | 12+ | 🌐 網頁與應用 |
| 🟩 Markdown | [查看所有](#-詳細資源列表) | 5+ | 📝 文檔與說明 |
| 🟨 JSON | [查看所有](#-詳細資源列表) | 3+ | ⚙️ 配置與資料 |
| 🟨 JavaScript | [查看所有](#-詳細資源列表) | 8+ | 📜 指令碼與自動化 |
| 🟧 Python | [查看所有](#-詳細資源列表) | 2+ | 🐍 後端邏輯 |
...
├─────────────────┼─────────────────┼─────────────────┼─────────────────┤
│ 🟦 HTML         │ 🟦 HTML         │ 🟦 HTML         │ 🟦 HTML         │
│ **主入口**      │ **26篇文章**    │ **15個工具**    │ **官方百科**    │
│ 最新：7天前     │ 最新：3天前     │ 最新：5天前     │ 最新：14天前    │
│ ⭐⭐⭐⭐⭐    │ ⭐⭐⭐⭐     │ ⭐⭐⭐       │ ⭐⭐⭐⭐     │
│ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │
│ [訪問][編][RAW] │ [訪問][編][RAW] │ [訪問][編][RAW] │ [訪問][編][RAW] │
└─────────────────┴─────────────────┴─────────────────┴─────────────────┘
```
...
```
┌─────────────────┬─────────────────┬─────────────────┬─────────────────┐
│📋 **編輯工具**  │🎵 **音樂播放器**│🎨 **SVG編輯器**│🎥 **短影音**   │
├─────────────────┼─────────────────┼─────────────────┼─────────────────┤
│ 🟦 HTML         │ 🟧 目錄         │ 🟦 HTML         │ 🟧 目錄         │
│ **強大編輯**    │ **多媒體播放**  │ **向量圖形**    │ **短視頻庫**    │
│ 最新：10天前    │ 最新：20天前    │ 最新：8天前     │ 最新：15天前    │
│ ⭐⭐⭐⭐     │ ⭐⭐         │ ⭐⭐⭐       │ ⭐⭐         │
│ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │
│ [訪問][編][RAW] │ [訪問]-[RAW]    │ [訪問][編][RAW] │ [訪問]-[RAW]    │
└─────────────────┴─────────────────┴─────────────────┴─────────────────┘
```
...
```
┌─────────────────┬─────────────────┬─────────────────┬─────────────────┐
│🤖 **MobspOS**   │📡 **同步服務**  │🌐 **Browser**   │📂 **檔案清單**  │
├─────────────────┼─────────────────┼─────────────────┼─────────────────┤
│ 🟦 HTML         │ 🟦 HTML         │ 🟦 HTML         │ 🟦 HTML         │
│ **操作系統**    │ **Nexus Sync**  │ **網頁瀏覽**    │ **資源索引**    │
│ 最新：12天前    │ 最新：2天前     │ 最新：6天前     │ 最新：4天前     │
│ ⭐⭐⭐       │ ⭐⭐⭐⭐     │ ⭐⭐⭐       │ ⭐⭐⭐       │
│ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │ 🟢 公開        │
│ [訪問][編][RAW] │ [訪問][編][RAW] │ [訪問][編][RAW] │ [訪問][編][RAW] │
└─────────────────┴─────────────────┴─────────────────┴─────────────────┘
...
💡 **提示**：卡片在手機上會自動堆疊排列，在桌面上會並排顯示（響應式設計）
...
| 色點 | 📂 檔案格式 | 🎯 圖標 | 📝 說明 | 🔧 用途 |
|:---:|---|:---:|---|---|
| 🟦 | HTML | 🌐 | 網頁標記語言 | 🌍 網頁應用、互動界面 |
| 🟩 | Markdown | 📝 | 文檔標記格式 | 📚 說明文檔、內容編寫 |
| 🟨 | JSON | ⚙️ | 資料交換格式 | 🔧 配置文件、資料儲存 |
| 🟨 | JavaScript | 📜 | 網頁腳本語言 | 🎬 自動化、互動功能 |
| 🟧 | Python | 🐍 | Python 程式語言 | ⚙️ 後端邏輯、自動化 |
| 🟧 | 其他/目錄 | 📁 | 其他格式或文件夾 | 🗂️ 資源分類、模組管理 |
...
|:---:|---|:---:|
| `Ctrl/Cmd + F` | 頁面搜尋 | 全部 |
| `Ctrl/Cmd + C` | 複製連結（點擊 📋 後） | 全部 |
| `↑/↓` | 瀏覽表格 | 全部 |
| `Home/End` | 跳至頁面頂部/底部 | 全部 |
| `Ctrl/Cmd + Shift + I` | 開啟開發者工具 | 全部 |
...
本文件由自動化系統維護。若檔案清單與統計有誤，請：

1. ✅ 執行 `python auto-index.py` 重新生成
2. ✅ 觸發 GitHub Actions 自動部署
3. ✅ 確認網站更新完成

**📊 統計數據**：由 Python 腳本自動掃描並生成  
**🔄 更新頻率**：每次 Push 時自動執行  
**✨ 最後更新**：2026-07-03  
**🟢 自動維護**：✅ 啟用中
