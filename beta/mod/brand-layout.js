    ...
    const brandHTML = `
        <div style="text-align: center; padding: 20px 0;">
            <a href="" style="display: block; margin-bottom: 10px;">
                <img src="/assets/brand/ms-guide-title.webp" alt="莫比空間" style="width: 100%; border-radius: 8px; box-shadow: 0 10px 20px rgba(0,0,0,0.3);">
            </a>
            ...
            <div style="display: flex; justify-content: center; gap: 10px; margin-top: 10px;">
                <img src="https://img.shields.io/website?url=https%3A%2F%2F&label=Live%20Status&style=for-the-badge&color=black">
