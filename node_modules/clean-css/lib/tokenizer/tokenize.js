...
function intoTokens(source, externalContext, internalContext, isNested) {
  ...
  for (; position.index < source.length; position.index++) {
    ...
    if (isEscaped) {
      ...
      && seekingValue
      && !isBufferEmpty) {
      // forward slash within a property, e.g. a{background:url(image.webp) 0 0/<--
      serializedBuffer = buffer.join('').trim();
      propertyToken.push([
        Token.PROPERTY_VALUE,
        serializedBuffer,
      ...
      && level == Level.RULE
      && seekingValue) {
      // forward slash within a property after space, e.g. a{background:url(image.webp) 0 0 /<--
      propertyToken.push([
        Token.PROPERTY_VALUE,
        character,
        [[position.line, position.column, position.source]]
      ...
      // comma within a property, e.g. a{background:url(image.webp),<--
      serializedBuffer = buffer.join('').trim();
      propertyToken.push([
        Token.PROPERTY_VALUE,
        serializedBuffer,
      ...
      // comma within a property after space, e.g. a{background:url(image.webp) ,<--
      propertyToken.push([
        Token.PROPERTY_VALUE,
        character,
        [[position.line, position.column, position.source]]
